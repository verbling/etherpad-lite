...
var padeditbar = (function() {
  ...
  function aceAttributeCommand(cmd, ace) {
    console.log("@#$IN ACE ATTRIBUTE COMMAND");
  ...
  function registerDefaultCommands(toolbar) {
    ...
    console.log("@#$ DO REGISTER BOLD COMMAND");
    ...
    console.log("@#$ do registerAceCommand");
    toolbar.registerAceCommand("insertorderedlist", function(cmd, ace) {
      console.log("@#$ register ace command cb");
    ...
    toolbar.registerAceCommand("clearauthorship", function(cmd, ace) {
      if (
        !(ace.ace_getRep().selStart && ace.ace_getRep().selEnd) ||
        ace.ace_isCaret()
      ) {
